...
2. Compressez le dossier `disposableemailfilter` en fichier ZIP
...
1. Téléchargez ou clonez ce dépôt
2. Copiez le dossier complet `disposableemailfilter` dans le répertoire `modules` de votre installation PrestaShop
...
https://github.com/cesar-cardinale/disposableemailfilter/issues
