...
2. Copy the `disposableemailfilter` folder to your PrestaShop `modules` directory
...
For issues, questions, or contributions, please visit the [GitHub repository](https://github.com/cesar-cardinale/disposableemailfilter).
